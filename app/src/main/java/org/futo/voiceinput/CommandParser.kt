...
object CommandParser {
    ...
    fun parseAndExecute(context: Context, text: String, onStatusUpdate: (String) -> Unit) {
        ...
        val shutdownKeywords = listOf("כיבוי", "תכבה", "לכבות", "כבה", "נגן", "מכשיר")
        val rebootKeywords = listOf("מחדש", "הפעלה", "הפעל", "תפעיל", "נגן", "מכשיר")
        val playKeywords = listOf("נגן", "תפעיל", "הפעל", "מוזיקה", "שיר", "להשמיע", "תשמיע")
        val stopKeywords = listOf("עצור", "תעצור", "תפסיק", "מוזיקה", "שיר")
        val screenOnKeywords = listOf("להדליק", "תדליק", "הדלק", "הדלקה", "מסך")
        val screenOffKeywords = listOf("לכבות", "תכבה", "כבה", "כיבוי", "מסך")
        val volumeUpKeywords = listOf("להגביר", "תגביר", "הגבר", "הגברה", "ווליום", "קול")
        ...
        val bluetoothOnKeywords = listOf("להפעיל", "תפעיל", ",תדליק", "להדליק", "הדלק", "הפעל", "בלוטוס", "בלוטות")
        val bluetoothOffKeywords = listOf("לכבות", "תכבה", "כבה", "כיבוי", "בלוטוס", "בלוטות")
        val marketKeywords = listOf("חנות", "אפליקציות", "הורדות", "התקנת", "פתח", "הורדה", "התקנה")
        val galleryKeywords = listOf("גלריה", "תמונות", "פתח")
        val radioOnKeywords = listOf("להפעיל", "תפעיל", "פתח", "תפתח", "תדליק", "הדלק", "הפעל", "רדיו")
        val fileTransferKeywords = listOf("העברת", "קבצים", "להעביר", "קובץ", "שלח", "שליחה", "שליחת")

        // קבוצות הגדרות (כלליות וספציפיות)
        val bluetoothSettingsKeywords = listOf("הגדרות", "הגדרת", "הגדרה", "בלוטוס", "בלוטות", "תפתח", "פתח", "לפתוח")
        val appsSettingsKeywords = listOf("הגדרות", "הגדרת", "הגדרה", "יישומים", "אפליקציות", "ישומים", "תפתח", "פתח", "לפתוח")
        val generalSettingsKeywords = listOf("הגדרות", "מכשיר", "פתח", "לפתוח", "תפתח")
